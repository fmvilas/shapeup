        ...
        }
        {
          pitches.map((pitch, index) => (
            <li key={index} className="col-span-1 flex flex-col text-center bg-white rounded-lg shadow">
              <a href={pitch.url} target="_blank" className="flex-1 flex flex-col p-8 bg-cover rounded-tl-lg rounded-tr-lg" style={{ backgroundImage: `url('/img/backgrounds/${index % 9 + 1}.webp')` }}>
