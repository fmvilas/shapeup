...
export default function Header() {
  const { title, number, org, ownerType, githubUrl } = useProjectDetails()
  ...
  return (
    <div className="lg:flex lg:justify-between">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <a href={githubUrl} title="GitHub Project" target="_blank" className="block text-gray-400 hover:text-gray-800">
