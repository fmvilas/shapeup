...
export function Intro() {
  return (
    <>
      ...
      <a onClick={() => signIn('github')} className="inline-flex flex-row pointer align-middle mt-8 px-5 py-4 border-sky-700 border rounded-lg hover:border-sky-950 hover:bg-sky-950">
